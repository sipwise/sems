...
# optional parameter: rtcp_send_interval=<seconds>
#
# - interval between RTCP reports generated by SEMS; 0 disables own
#   report generation (relaying of incoming RTCP is not affected).
#   Recommended value per RFC 3550: 5.
#
#   default=0 (disabled)
#
#rtcp_send_interval=5

# optional parameter: rtcp_mode={auto|generate|passthru}
#
# - who sends RTCP reports to the remote side per stream:
#     auto     - own streams: SEMS generates reports;
#                relayed streams: relay incoming RTCP; while SEMS replaces
#                the stream's media with its own (announcement, MoH), it
#                also generates SR reports for its own SSRC; streams held
#                by SEMS are reported by SEMS itself (RR), incoming RTCP is
#                not relayed into them (default);
#     generate - SEMS generates reports for all streams;
#     passthru - SEMS never generates reports, only relays incoming RTCP.
#   Own report generation (auto/generate) requires rtcp_send_interval > 0;
#   relaying of incoming RTCP and parsing it for stream statistics do not
#   depend on rtcp_send_interval.
#
#   default=auto
#
#rtcp_mode=auto
