...
XmlRpcServerConnection::readHeader()
{
  ...
  XmlRpcUtil::log(4, "XmlRpcServerConnection::readHeader: read %zu bytes.", static_cast<size_t>(_header.length()));
...
XmlRpcServerConnection::readRequest()
{
  ...
  XmlRpcUtil::log(3, "XmlRpcServerConnection::readRequest read %zu bytes.", static_cast<size_t>(_request.length()));
